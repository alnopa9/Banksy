...
function init() {
    ...
    function rotateDonuts() {
        var imagesDounts = new ArrayDounts ('../img/paintings/donuts_brown_chocolate.jpg', '../img/paintings/donuts_pink_strawberry.jpg')
            var thisImageDounts = 0;
        var thisImageDounts = Math.floor(Math.random()*(imagesDounts.length)) ;
        document.getElementById("donuts_rotator").src = imagesDounts[thisImageDounts];
        setTimeout(rotateDonuts, 3 * 1000);
    }

    function rotateFlags() {
        var imagesFlags = new ArrayFlags ('../img/paintings/flags_gold.jpg', '../img/paintings/flags_silver.jpg')
    ...
    function rotateFlyingCopper() {
        var imagesFlyingCopper = new ArrayFlyingCopper ('../img/paintings/flying_copper_blue.jpg', '../img/paintings/flying_copper_pink.jpg')
    ...
    function rotateGangsta() {
        var imagesGangsta = new ArrayGangsta ('../img/paintings/gangsta_rat_green.jpg', '../img/paintings/gangsta_rat_pink.jpg', '../img/paintings/gangsta_rat_red.jpg')
    ...
    function rotateGOWYC() {
        var imagesGOWYC = new ArrayGOWYC ('../img/paintings/get_out_while_you_can_red.jpg', '../img/paintings/get_out_while_you_can_pink.jpg')
    ...
    function rotateIFTL() {
        var imagesIFTL = new ArrayIFTL ('../img/paintings/i_fought_the_law_orange.jpg', '../img/paintings/i_fought_the_law_pink.jpg', '../img/paintings/i_fought_the_law_red.jpg')
            var thisImageIFTL = 0;
    ...
    function rotateJandJ() {
        var imagesJandJ = new ArrayJandJ ('../img/paintings/jack_and_jill_blue.jpg', '../img/paintings/jack_and_jill_pink.jpg')
    ...
    function rotateKateMoss() {
        var imagesKateMoss = new ArrayKateMoss ('../img/paintings/kate_moss.jpg', '../img/paintings/kate_moss_apricot_gold.jpg', '../img/paintings/kate_moss_bue_grey.jpg', '../img/paintings/kate_moss_green.jpg', '../img/paintings/kate_moss_pink.jpg', '../img/paintings/kate_moss_purple.jpg')
    ...
    function rotateMorons() {
        var imagesMorons = new ArrayMorons ('../img/paintings/morons_la_edition_sepia.jpg', '../img/paintings/morons_la_edition_white.jpg', '../img/paintings/morons_sepia.jpg', '../img/paintings/morons_white.jpg')
    ...
    function rotateNaplam() {
        var imagesNapalm = new ArrayNapalm ('../img/paintings/napalm.jpg', '../img/paintings/napalm_orange.jpg', '../img/paintings/napalm_rainbow.jpg', '../img/paintings/napalm_serpentine_edition.jpg')
    ...
    function rotateBallGames() {
        var imagesBallGames = new ArrayBallGames ('../img/paintings/no_ball_games_green.jpg', '../img/paintings/no_ball_games_grey.jpg')
    ...
    function rotateNola() {
        var imagesNola = new ArrayNola ('../img/paintings/nola_grey.jpg', '../img/paintings/nola_orange.jpg', '../img/paintings/nola_pink_and_yellow_rain.jpg', '../img/paintings/nola_white.jpg', '../img/paintings/nola_yellow.jpg')
            var thisImageNola = 0;
    ...
    function rotateTrolleys() {
        var imagesTrolleys = new ArrayTrolleys ('../img/paintings/trolleys_black_and_white.jpg', '../img/paintings/trolleys_colour.jpg')
    ...
    function rotateWorthless() {
        var imagesWorthless = new ArrayWorthless ('../img/paintings/worthless_pink.jpg', '../img/paintings/worthless_red.jpg')
